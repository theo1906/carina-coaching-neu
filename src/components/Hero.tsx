...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-pink-50">
      ...
      <div className="relative w-full h-[90vh] min-h-[600px] max-h-[800px]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full relative z-10">
          <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-full max-w-4xl px-4">
            <div className="bg-white px-6 pt-6 pb-4 md:px-8 md:pt-8 md:pb-5 rounded-t-2xl rounded-b-2xl shadow-sm text-center relative z-20" style={{ marginBottom: '2rem' }}>
              <div className="-mt-2">
