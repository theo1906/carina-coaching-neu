            ...
            <div className="bg-white px-6 pt-6 pb-4 md:px-8 md:pt-8 md:pb-5 rounded-t-2xl rounded-b-2xl shadow-sm text-center">
              <div className="-mt-2">
                ...
                <p className="text-lg md:text-xl text-black leading-relaxed max-w-3xl mx-auto -mt-4">
                  Als spiritueller Life Coach und systemischer Coach unterstütze ich Frauen dabei, ihre eigene Heilkraft und Wahrheit zu erkennen und mutig zu verkörpern.
                </p>
              </div>
              <div className="mt-8">
                <DropdownQuestions />
