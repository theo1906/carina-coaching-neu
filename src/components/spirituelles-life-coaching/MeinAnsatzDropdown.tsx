...
export default function MeinAnsatzDropdown() {
      ...
      <div className={`transition-all duration-300 ${isOpen ? 'max-h-none opacity-100' : 'max-h-0 opacity-0 overflow-hidden'}`}>
        <div className="max-w-6xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
          <div className="prose prose-pink prose-lg max-w-none text-gray-700">
            <h2 className="sr-only">Transform in who you truly are</h2>
            <h1 aria-hidden="true" className="text-3xl md:text-4xl font-bold text-black mb-4 text-center">"Transform in who you truly are"</h1>
