    ...
    <>
      ...
      >
        ...
        <div className="text-center">
          <h2 className="sr-only">Mein Weg</h2>
              ...
              <div className="w-full">
                ...
                <blockquote className="mt-2 text-[15px] leading-7 text-[#3c3c3c] max-w-3xl mx-auto text-justify">
                  ...
                  <p>
                    ...
                    und meinen spirituellen Ansatz von trauma-sensiblem, körperzentriertem 
    ...
    <section className="py-16 bg-gradient-to-b from-white to-rose-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h3 className="sr-only">Meine Qualifikationen und Corporate Jobs</h3>
          <h2 className="text-4xl md:text-5xl font-bold text-rose-900 mb-4">
            Meine Qualifikationen und Corporate Jobs
          </h2>
          <div className="w-24 h-1 bg-gradient-to-r from-fuchsia-400 to-rose-400 mx-auto mb-6"></div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-rose-100">
            <div className="p-6">
              <h4 className="sr-only">Zertifizierte Ausbildungen</h4>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">
                    <span className="font-semibold">Okt 2024 - Okt 2025:</span> Assistenz Ausbildung Spirituelles System-Coaching, Dr. Klaus Peter Horn Coaching & Training, München
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="flex-shrink-0 w-2 h-2 mt-2 rounded-full bg-rose-400 mr-3"></span>
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-rose-100">
            <div className="p-6">
              <h4 className="sr-only">Weiterführende Trainings in Trauma-/ Persönlichkeitsarbeit und Conscious Relating</h4>
              <h3 className="text-2xl font-bold text-rose-800 mb-6 flex items-center">
                <svg className="w-6 h-6 mr-2 text-rose-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="mt-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-rose-100">
            <div className="p-6">
              <h4 className="sr-only">Corporate Karriere & Qualifikationen</h4>
              <h3 className="text-2xl font-bold text-rose-800 mb-6 flex items-center">
                <svg className="w-6 h-6 mr-2 text-rose-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
