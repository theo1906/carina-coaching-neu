        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 text-center">
            <p className="text-base text-gray-500">
              ...
              <a href="mailto:carina.goeb@googlemail.com?subject=Anfrage%20%C3%BCber%20Carina%20Coaching&body=Sehr%20geehrte%20Frau%20Goeb%2C%0D%0A%0D%0A" className="font-medium text-primary-600 hover:text-primary-500">
                Nachricht schreiben
              </a>
            </p>
          </div>
