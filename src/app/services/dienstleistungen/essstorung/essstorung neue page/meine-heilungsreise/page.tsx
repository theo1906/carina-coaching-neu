        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <Link
              ...
              as="/Services/essstorung#embodiment"
              scroll={false}
      ...
      <section className="relative py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-gray-700 text-lg leading-relaxed">
            ...
            <p>
              Damals war ich da nicht. Der Preis war hoch: ich war über 20 Jahre lang nie ehrlich, mir selbst gegenüber nicht und keinem anderen. Damals mit Beginn der Krankheit war ich 14 Jahre alt. Ich habe mich so sehr geschämt, dass ich mich lieber habe schlagen und demütigen lassen als zu erzählen, was mit mir los ist.
            </p>
            ...
            <p>
              Als junge Frau war ich so abgeschnitten von mir und meinem Körper, dass ich keinerlei Grenzen gespürt und auch nicht gesetzt habe - weder in Beziehungen noch in meinen sexuellen Erfahrungen. Übergriffe, Drogen, Ambivalenz, Co-Abhängigkeit und eine 9 Jahre lang narzisstische On und Off Beziehung waren die Folge.
            </p>
            ...
            <p>
              Das hat in mir eine Kraft geweckt, die mich angefangen hat zu leiten. Diese Stimme in mir wurde immer deutlicher und mit ihr kam meine tiefe Herzensentscheidung zu leben: gesund, selbstbestimmt und glücklich. Ich war fest entschlossen.
            </p>
            
            <p>
              Die Heilung kam über Nacht. Unerwartet und ohne jegliche Vorankündigung. Es war wie eine Art „energetisches Cleansing“, das stattgefunden hat und mein System befreit hat von Fremdenergien und Emotionen, die ich all die Jahre unterdrückt und dadurch bei mir gehalten habe.
            </p>
            
            <p>
              Ich erinnere mich noch wie heute an den Tag danach. Das erste Mal nach 20 Jahren hatte ich nicht mehr den Zwang, mich zu übergeben nach dem Essen. Im Gegenteil: alles in mir hat sich verbunden angefühlt und so friedlich. Es war magisch und ist es bis heute.
            </p>
            
            <p className="text-2xl font-serif italic text-gray-700 my-12">
            ...
            <div className="mt-16 text-center">
              <Link 
                href="/kontakt" 
                className="inline-flex items-center px-8 py-3 border border-transparent text-base font-medium rounded-full shadow-sm text-white bg-pink-600 hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500 transition-colors duration-300"
              >
                Lass uns sprechen
              </Link>
            </div>
