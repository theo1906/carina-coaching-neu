...
export const metadata = {
  title: 'Deine Reise zurück zu dir | Carina Göb',
  description: 'Entdecke deine Essenz und entfalte dein Potenzial durch spirituelles Coaching. Erfahre, wie du in Verbindung mit dir selbst und deiner weiblichen Kraft kommst.',
};

export default function ReiseZurueckZuDirPage() {
  return (
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-2xl text-pink-800/90 italic max-w-2xl mx-auto">
              "ERINNERE DICH AN DEINE ESSENZ. ENTFALTE DEIN WAHRES SELBST."
            </p>
          </div>
