    ...
    <main className="min-h-screen bg-white pt-32 pb-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-light text-gray-900 mb-4">Datenschutzerklärung</h1>
        ...
        <div className="prose prose-lg max-w-none prose-p:normal-case">
          <h2 className="text-2xl font-medium text-gray-800 mb-6">1. Allgemeine Hinweise</h2>
          <p className="mb-6">
          ...
          <p className="mb-6">
            <strong>Verantwortlich für die Datenverarbeitung ist:</strong><br />
            Carina Göb<br />
            Carina Göb Coaching – Embodiment for Women<br />
            Jella-Lepman-Str. 17<br />
            81673 München<br />
            E-Mail: <a href="mailto:connect@carina-coaching.de" className="text-pink-600 hover:underline">connect@carina-coaching.de</a>
          </p>
          
          <h2 className="text-2xl font-medium text-gray-800 mt-12 mb-6">2. Zugriffsdaten / Server-Logfiles</h2>
          <p className="mb-6">
            Beim Besuch dieser Website werden automatisch Informationen erfasst (sogenannte Server-Logfiles), darunter:
          ...
          <p className="mb-6">
            Diese Daten dienen ausschließlich der Sicherstellung eines störungsfreien Betriebs und werden nicht mit anderen Datenquellen zusammengeführt. Eine personenbezogene Auswertung erfolgt nicht.
          </p>
          
          <h2 className="text-2xl font-medium text-gray-800 mt-12 mb-6">3. Terminbuchung</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-medium text-gray-800 mt-12 mb-6">4. Anonyme Fragen und Feedback-Funktion</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-medium text-gray-800 mt-12 mb-6">5. Kontaktaufnahme per E-Mail oder Formular</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-medium text-gray-800 mt-12 mb-6">6. Cookies und Drittanbieter-Technologien</h2>
          <p className="mb-6">
          ...
          <h3 className="text-xl font-medium text-gray-800 mt-8 mb-4">6.1 Cookie-Kategorien</h3>
          ...
          <h2 className="text-2xl font-medium text-gray-800 mt-12 mb-6">7. Deine Rechte nach der DSGVO</h2>
          <p className="mb-6">
          ...
          <p className="mb-6">
            Du kannst dich außerdem bei einer Datenschutz-Aufsichtsbehörde beschweren, wenn du der Ansicht bist, dass die Verarbeitung deiner personenbezogenen Daten rechtswidrig erfolgt.
          </p>
          <p className="mb-6">
            <strong>Zuständige Aufsichtsbehörde in Bayern:</strong><br />
            Bayerisches Landesamt für Datenschutzaufsicht (BayLDA)<br />
            <a href="https://www.lda.bayern.de" target="_blank" rel="noopener noreferrer" className="text-pink-600 hover:underline">www.lda.bayern.de</a>
          </p>
          
          <h2 className="text-2xl font-medium text-gray-800 mt-12 mb-6">8. Änderung dieser Datenschutzerklärung</h2>
          <p className="mb-12">
            Ich behalte mir vor, diese Datenschutzerklärung anzupassen, um sie an aktuelle rechtliche Anforderungen oder Änderungen meines Angebots anzupassen. Die jeweils aktuelle Version findest du stets auf dieser Website.
          </p>
